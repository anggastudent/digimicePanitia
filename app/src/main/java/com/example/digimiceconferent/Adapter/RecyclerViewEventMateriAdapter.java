...
import com.example.digimiceconferent.Activity.UploadMateri;
...
public class RecyclerViewEventMateriAdapter extends RecyclerView.Adapter<RecyclerViewEventMateriAdapter.EventMateriViewHolder> {
    ...
    @NonNull
    @Override
    public EventMateriViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_event_materi, parent, false);
        return new EventMateriViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final EventMateriViewHolder holder, int position) {
        ...
        holder.btnDetail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(holder.itemView.getContext(), UploadMateri.class);
    ...
    public class EventMateriViewHolder extends RecyclerView.ViewHolder {
        TextView judul, start;
        Button btnDetail;
        ImageView banner;
        public EventMateriViewHolder(@NonNull View itemView) {
            super(itemView);

            judul = itemView.findViewById(R.id.judul_item_materi);
            start = itemView.findViewById(R.id.item_start_materi);
            btnDetail = itemView.findViewById(R.id.bt_detail_item_materi);
            banner = itemView.findViewById(R.id.img_item_materi);
        }
    }
}
